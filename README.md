...
The project focuses on analyzing road infrastructure data to gain insights  road mileage distribution, surface types, paving status, and truck route networks across different counties.
